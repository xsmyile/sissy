...
- `app/` — macOS 26+ Xcode workspace, two targets:
  ...
  - `sissy-serverd` — native daemon (`app/SissyCore/`), built as a command-line tool and copied into `Sissy.app/Contents/MacOS/` so the app ships the daemon as a single bundle.
